...
project = 'Zwalker\'s BLOG'
copyright = '2018, Zwalker'
...
latex_documents = [
    (master_doc, 'ZwalkersBLOG.tex', 'Zwalker\'s BLOG Documentation',
     'Zwalker', 'manual'),
]
...
man_pages = [
    (master_doc, 'zwalkersblog', 'Zwalker\'s BLOG Documentation',
     ['Zwalker'], 1)
]
...
texinfo_documents = [
    (master_doc, 'ZwalkersBLOG', 'Zwalker\'s BLOG Documentation',
     'Zwalker', 'ZwalkersBLOG', 'One line description of project.',
     'Miscellaneous'),
]
